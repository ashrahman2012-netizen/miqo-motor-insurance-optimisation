...
const checks = [
  ...
  ["apps/customer-web/package.json", "dependencies", ["@miqo/application-adapters", "@miqo/application-contracts", "@miqo/ui", "next", "react", "react-dom"]],
  ...
  ["packages/application-adapters/package.json", "dependencies", ["@miqo/application-contracts"]],
  ["packages/application-adapters/package.json", "devDependencies", ["typescript", "vitest"]],
