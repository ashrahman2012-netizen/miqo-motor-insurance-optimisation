...
export default defineConfig({testDir:"./e2e-target",timeout:45000,use:{baseURL:"http://127.0.0.1:3000",trace:"retain-on-failure"},webServer:[
 ...
 {command:"NEXT_PUBLIC_API_URL=http://127.0.0.1:4000 NEXT_PUBLIC_ADMIN_WEB_URL=http://127.0.0.1:3001 npm run dev -w @miqo/customer-web",url:"http://127.0.0.1:3000",reuseExistingServer:false,timeout:60000},
 {command:"NEXT_PUBLIC_API_URL=http://127.0.0.1:4000 npm run dev -w @miqo/admin-web",url:"http://127.0.0.1:3001",reuseExistingServer:false,timeout:60000}
