...
| R-G1-001 | Tauri introduces Rust/MSVC into a Node/npm repository. | CLOSED FOR BUILD/PACKAGE / INSTALL PROOF PENDING | G4/G7/G8 | G7-B compiled Rust/Tauri and produced NSIS on Windows; installed-runtime proof remains G8. |
...
| R-G4-005 | Packaging design has not yet been executed against the real Desktop scaffold. | PARTIALLY CLOSED | G7/G8 | Real NSIS package produced in G7-B; install/upgrade/uninstall proof remains G8. |
